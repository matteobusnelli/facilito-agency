      ...
      <div className="container mx-auto px-6 relative z-10 pt-28 pb-20 md:pt-32 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-6 items-center">
          ...
          <div>
            ...
            <motion.h1
              {...fadeUp(0.1)}
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.05] tracking-tight text-white mb-7"
            >
              <span className="block whitespace-nowrap">{t.hero.line1}</span>
              <span className="block whitespace-nowrap">{t.hero.line2}</span>
              <span className="block whitespace-nowrap text-gradient-warm animate-gradient-shimmer">{t.hero.line3}</span>
            </motion.h1>
          ...
          {/* RIGHT — brand graphic: the mark stays still, only the ring of light around it flows.
              Rendered only once the intro handoff fires — its layoutId picks up the FLIP
              transition from IntroOverlay's centered copy into this exact spot. */}
